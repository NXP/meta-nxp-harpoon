...
LIC_FILES_CHKSUM = "file://${UNPACKDIR}/arm-gnu-toolchain-13.2.Rel1-x86_64-aarch64-none-elf/license.txt;md5=3a4c8f624bd77882c8dc3beb13171154"
...
do_install () {
	...
	cp -R --no-dereference --preserve=mode,links -v ${UNPACKDIR}/arm-gnu-toolchain-13.2.Rel1-x86_64-aarch64-none-elf/* ${D}${bindir}/${PN}-${PV}/
}
