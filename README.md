i.MX Linux Yocto Project BSP 6.12.20-2.0.0 Harpoon v3 Release
=============================================================
...
```
$ repo init -u https://github.com/nxp-imx/imx-manifest -b imx-linux-walnascar -m imx-6.12.20-2.0.0_harpoon-v3.xml
```
