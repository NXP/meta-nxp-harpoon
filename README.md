i.MX Linux Yocto Project BSP 6.6.36-2.1.0 Harpoon v3 Release
=============================================================
...
```
$ repo init -u https://github.com/nxp-imx/imx-manifest -b imx-linux-scarthgap -m imx-6.6.36-2.1.0_harpoon-v3.xml
```
